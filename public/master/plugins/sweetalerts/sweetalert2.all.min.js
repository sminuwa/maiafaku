!function (e, t) {
    ...
    const g = e(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "default-outline", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error"]),
        ...
        b = () => document.body.querySelector(".".concat(g.container)), f = e => {
            const t = b();
            return t ? t.querySelector(e) : null
        }, y = e => f(".".concat(e)), v = () => y(g.popup), w = () => y(g.icon), C = () => y(g.title),
        k = () => y(g["html-container"]), A = () => y(g.image), P = () => y(g["progress-steps"]),
        B = () => y(g["validation-message"]), x = () => f(".".concat(g.actions, " .").concat(g.confirm)),
        E = () => f(".".concat(g.actions, " .").concat(g.deny));
    const S = () => f(".".concat(g.loader)), T = () => f(".".concat(g.actions, " .").concat(g.cancel)),
        L = () => y(g.actions), O = () => y(g.footer), j = () => y(g["timer-progress-bar"]), D = () => y(g.close),
        M = () => {
    ...
    const q = {previousBodyPadding: null}, V = (t, e) => {
        ...
        Q = () => !G(x()) && !G(E()) && !G(T()), ee = e => !!(e.scrollHeight > e.clientHeight), te = e => {
        ...
        se = () => {
            ...
            if (oe()) r("SweetAlert2 requires document to initialize"); else {
                ...
                o.appendChild(n), (e => {
                    ...
                    const e = v(), t = K(e, g.input), n = K(e, g.file), o = e.querySelector(".".concat(g.range, " input")),
                        i = e.querySelector(".".concat(g.range, " output")), s = K(e, g.select),
                        a = e.querySelector(".".concat(g.checkbox, " input")), r = K(e, g.textarea);
            ...
            const n = L();
            var o = S(), i = x(), s = E(), a = T();
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? Z : J)(n), U(n, t, "actions"), pe(i, "confirm", t), pe(s, "deny", t), pe(a, "cancel", t), function (e, t, n, o) {
    ...
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], be = e => {
    ...
    }, Se = e => '<div class="'.concat(g["icon-content"], '">').concat(e, "</div>"), Te = (e, o) => {
        const i = P();
    ...
    function st(e, t, n, o) {
        H() ? ut(e, o) : (He(n).then(() => ut(e, o)), Ie.keydownTarget.removeEventListener("keydown", Ie.keydownHandler, {capture: Ie.keydownListenerCapture}), Ie.keydownHandlerAdded = !1), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), I() && (null !== q.previousBodyPadding && (document.body.style.paddingRight = "".concat(q.previousBodyPadding, "px"), q.previousBodyPadding = null), N(document.body, g.iosfix) && (t = parseInt(document.body.style.top, 10), _(document.body, g.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t), ot()), _([document.documentElement, document.body], [g.shown, g["height-auto"], g["no-backdrop"], g["toast-shown"]])
    }
    ...
    const bt = ["swal-title", "swal-html", "swal-footer"], ft = e => {
        ...
        }, Ot = e => e.checked ? 1 : 0, jt = e => e.checked ? e.value : null,
        Dt = e => e.files.length ? null !== e.getAttribute("multiple") ? e.files : e.files[0] : null, Mt = (t, n) => {
            const o = v(), i = e => Ht[n.input](o, qt(e), n);
        ...
        }, Vt = (e, t) => t && t.toString() === e.toString(), Nt = (e, t) => {
            var n = ge.innerParams.get(e), o = ((e, t) => {
                const n = e.getInput();
                if (!n) return null;
                switch (t.input) {
                    case"checkbox":
            ...
            v().focus()
        }, Kt = ["ArrowRight", "ArrowDown"], Yt = ["ArrowLeft", "ArrowUp"], Zt = (e, t, n) => {
    ...
    e = Object.freeze({
        hideLoading: Xe, disableLoading: Xe, getInput: function (e) {
        ...
        }, close: at, isAwaitingPromise: function () {
            return !!ge.awaitingPromise.get(this)
        }, rejectPromise: function (e) {
            const t = it.swalPromiseReject.get(this);
            rt(this), t && t(e)
        }, closePopup: at, closeModal: at, closeToast: at, enableButtons: function () {
            ...
            Ze(Object.assign({}, t, e)), Ie.currentInstance && (Ie.currentInstance._destroy(), I() && ot()), Ie.currentInstance = this, ht(e = ((e, t) => {
                const n = ft(e), o = Object.assign({}, Re, t, n, e);
