            ...
            <div class="widget-content widget-content-area br-6">
                <div class="float-right">
                    <a href="#{{--{{ route('inventory.items.create') }}--}}" class="btn btn-primary add">
                        <i class="las la-plus-circle"></i> Add customers
                    </a>
                </div>
                <h4 class="table-header mb-4">Manage customers</h4>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="#" title="Delete" class="font-20 text-danger warning delete"
                                       id="{{ $customer->id }}"><i class="las la-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
@section('modals')
    <div id="addEditCustomerModal" class="modal animated {{ modalAnimation() }}" role="dialog">
        <div class="modal-dialog {{ modalClasses() }}">
            <!-- Modal content-->
            <div class="modal-content {{ modalPadding() }}">
                <div class="modal-header">
                    <h5 class="modal-title">Add/Edit Customers</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="addEditCustomerForm" method="post" action="{{ route('inventory.customers.store') }}">
                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.widget-content .warning.delete').on('click', function () {
                ...
                let url = "{{ route('inventory.customers.destroy',':id') }}"
