                    ...
                    <table class="export-data table" style="width:100%">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('payroll.staff.payslip', $user->id) }}" class="text-secondary">
                                        {{ $user->fullName() }}
                                    </a>
                                </td>
                                <td>{{ $user->activeLevel()->level ?? null }} / {{ $user->activeLevel()->step ?? null }}</td>
                                <td>{{ $user->grossSalary(2) }}</td>
                                <td>{{ $user->totalDeduction(2) }}</td>
                                <td>{{ $user->netSalary(2) }}</td>
                                <td class="text-right">
                                    ...
                                    <a href="#" title="Delete" class="font-20 text-danger warning delete"
                                       id="{{ $user->id }}"><i class="las la-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
